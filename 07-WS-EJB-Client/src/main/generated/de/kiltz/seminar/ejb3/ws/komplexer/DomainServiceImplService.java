...
@WebServiceClient(name = "DomainServiceImplService",
                  wsdlLocation = "http://localhost:8080/WS/DomainServiceImpl?wsdl",
...
public class DomainServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/WS/DomainServiceImpl?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DomainServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/WS/DomainServiceImpl?wsdl");
        }
        WSDL_LOCATION = url;
    }
