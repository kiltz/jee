 ...
 * 
 */
@WebServiceClient(name = "DomainServiceImplService", targetNamespace = "http://komplexer.ws.ejb3.seminar.kiltz.de/", wsdlLocation = "http://127.0.0.1:8080/WS/DomainServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:8080/WS/DomainServiceImpl?wsdl");
